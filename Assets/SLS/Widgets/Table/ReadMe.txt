...
Release Notes 1.30 (2019.02.12)
  Bug: Scrollbars now no longer have extra indentation when unnecessary
  Bug: Now properly stopping coroutines via handle instead of name

Release Notes 1.29 (2019.02.07)
  BUG: Now properly using Default Text shader in recent Unity revs
...
Release Notes 1.27 (2018.10.30)
  BUG: Input cell behaviour adjusted on single-input rows
